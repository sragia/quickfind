...
local SetupFrame = function (f)
    ...
    bg:SetTexture(QF.default.buttonBg)
    ...
    keybind:SetFont(QF.default.font, 13, 'OUTLINE')
    ...
    hoverTexture:SetTexture(QF.default.buttonHover)
    ...
    local onHover = QF.utils.animation.fade(hover, 0.1, 0, 1)
    local onLeave = QF.utils.animation.fade(hover, 0.1, 1, 0)
    f.onHover = onHover
    f.onLeave = onLeave
    ...
    name:SetFont(QF.default.font, 12, 'OUTLINE')
    name:SetPoint('LEFT')
    name:SetWidth(0)
    f.name = name
